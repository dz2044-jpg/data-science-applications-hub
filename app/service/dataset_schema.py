...
def get_dataset_schema(*, dataset_name: str) -> ApiDatasetSchemaResults:
    file_bytes = read_dataset_bytes(
        data_dir=get_data_dir(),
        dataset_name=dataset_name,
    )
    return get_dataset_schema_from_bytes(file_bytes=file_bytes, filename=dataset_name)
...
def get_generic_dataset_schema_from_path(*, file_path: Path, dataset_name: str) -> ApiCoreDatasetSchemaResults:
    return get_core_schema_from_path(file_path=file_path, dataset_name=dataset_name)
