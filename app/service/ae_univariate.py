...
from app.calc.ae_univariate import (
...
from app.models.ae import (
    ApiColumnMapping as ApiAeColumnMapping,
)
...
def perform_ae_univariate(*, params: ApiAeUnivariateParameters) -> ApiAeUnivariateResults:
    """Perform A/E univariate analysis from dataset file."""
    ...
    df = read_dataframe_from_bytes(
        ...
        filename=params.dataset_name,
    )
    return _perform_ae_univariate_core(df=df, params=params)


def perform_ae_univariate_from_csv(*, csv_bytes: bytes, params: ApiAeUnivariateParameters) -> ApiAeUnivariateResults:
    """Perform A/E univariate analysis from uploaded CSV bytes (deprecated - use perform_ae_univariate_from_upload)."""
