...
def _get_env_value(primary: str, legacy: str) -> str | None:
...
def _get_int_env(
    ...
    *,
    ...
    raw = _get_env_value(primary, legacy)
    if raw is None:
        return default
